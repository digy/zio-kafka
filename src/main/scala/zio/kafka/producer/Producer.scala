...
object Producer {
  ...
  def produce[K, V](
    ...
    keySerializer: Serializer[K],
    valueSerializer: Serializer[V]
  ): RIO[Has[Producer], RecordMetadata] =
  ...
  def produceAll[K, V](
    keySerializer: Serializer[K],
    valueSerializer: Serializer[V]
  ): ZTransducer[Has[Producer], Throwable, ProducerRecord[K, V], RecordMetadata] =
    ZTransducer.fromPush {
      case None => UIO.succeed(Chunk.empty)
      case Some(chunk) =>
  ...
  def produceAsync[K, V](
    ...
    keySerializer: Serializer[K],
    valueSerializer: Serializer[V]
  ): RIO[Has[Producer], Task[RecordMetadata]] =
  ...
  def produceChunkAsync[K, V](
    ...
    keySerializer: Serializer[K],
    valueSerializer: Serializer[V]
  ): RIO[Has[Producer], Task[Chunk[RecordMetadata]]] =
  ...
  def produceChunk[K, V](
    ...
    keySerializer: Serializer[K],
    valueSerializer: Serializer[V]
  ): RIO[Has[Producer], Chunk[RecordMetadata]] =
